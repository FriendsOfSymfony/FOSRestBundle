...
class ViewTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetRoute()
    {
        ...
        $view = View::createRouteRedirect($routeName, array(), LegacyCodesHelper::get('HTTP_CREATED'));
        $this->assertAttributeEquals($routeName, 'route', $view);
        $this->assertAttributeEquals(null, 'location', $view);
        $this->assertEquals(LegacyCodesHelper::get('HTTP_CREATED'), $view->getResponse()->getStatusCode());
