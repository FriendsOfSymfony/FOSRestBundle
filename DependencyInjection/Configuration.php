            ...
            ->children()
                ...
                ->arrayNode('classes')
                    ...
                    ->children()
                        ...
                        ->scalarNode('body_listener')->defaultValue('FOS\RestBundle\Listener\RequestListener')->end()
                        ->scalarNode('format_listener')->defaultValue('FOS\RestBundle\Listener\ControllerListener')->end()
                    ->end()
                ->end()
                ->arrayNode('services')
                    ->addDefaultsIfNotSet()
