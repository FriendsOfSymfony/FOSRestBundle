            ...
            ->children()
                ...
                ->arrayNode('service')
                    ...
                    ->children()
                        ...
                        ->scalarNode('body_listener')->defaultValue('fos_rest.body_listener')->end()
                        ->scalarNode('flash_message_listener')->defaultValue('fos_rest.flash_message_listener')->end()
                        ->scalarNode('format_listener')->defaultValue('fos_rest.format_listener')->end()
                        ->scalarNode('view_response_listener')->defaultValue('fos_rest.view_response_listener')->end()
                    ->end()
                ->end()
            ->end()
        ->end();
