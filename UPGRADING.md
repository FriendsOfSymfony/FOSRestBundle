 ...
 * `View::setSerializationContext` and `View::getSerializationContext` has been removed. Use `View::setContext` and `View::getContext` together with the new Context class instead.
